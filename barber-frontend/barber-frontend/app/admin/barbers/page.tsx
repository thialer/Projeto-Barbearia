...
export default function BarbersPage() {
  ...
  return (
    <div className="space-y-8">
      <Alert tone="success">
        Sua API ainda não tem uma rota para <strong>listar</strong> barbeiros já cadastrados (só existe para
        criar). Por isso, a lista abaixo mostra apenas os barbeiros criados nesta sessão — os que já existiam
        no banco não aparecem até adicionarmos essa rota no backend. Posso te ajudar a criar um{" "}
        <code>GET /api/admin/barbers</code> quando quiser.
      </Alert>
