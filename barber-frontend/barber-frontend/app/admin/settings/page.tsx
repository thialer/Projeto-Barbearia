...
export default function SettingsPage() {
  ...
  return (
    <div>
      ...
      <Alert tone="success" >
        Sua API ainda não tem uma rota <code>GET /api/admin/settings</code> para carregar os dados atuais, então
        este formulário começa em branco — preencha tudo antes de salvar, pois o endpoint substitui os dados
        inteiros da barbearia.
      </Alert>
      <Card className="mt-4">
